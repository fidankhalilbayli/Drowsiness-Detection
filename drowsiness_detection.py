...
def some_function(gray, face):
	...
	if right_distance>=80:
		cv2.putText(frame, 'FACE RIGHT', (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
	elif left_distance>=80:
		cv2.putText(frame, 'FACE LEFT', (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
	...
	if blinking_ratio > 5:
		cv2.putText(frame, "blink counter: "+ str(blink_counter), (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
		blink_counter+=1
		some_counter+=1
		cv2.putText(frame, "eyes closed", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
		cv2.putText(frame, str(some_counter/fps_int), (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
	else:
		cv2.putText(frame, "eyes open", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
		cv2.putText(frame, "blink frame "+ str(blink_counter), (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
		some_counter=0
	...
	if blinking_ratio <3.9:
		...
		if gaze_ratio <= 0.4:
			cv2.putText(frame, "EYE RIGHT", (10, 60), cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 0, 255), 2)
		elif 0.4 < gaze_ratio < 1.5:
			cv2.putText(frame, "EYE CENTER", (10, 60), cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 0, 255), 2)
		else:
			cv2.putText(frame, "EYE LEFT", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
	...
	if mouth_ear > 1.75:
		cv2.putText(frame, "YAWNING ", (10, 100),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
...
while True:
	...
	if face_counter!=0:
		cv2.putText(frame, str(face_counter) + " Faces detected", (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
	else:
		cv2.putText(frame, "No Faces detected", (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
